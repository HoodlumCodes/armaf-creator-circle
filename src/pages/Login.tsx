...
const Login = () => {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    // Mock login - replace with actual Supabase auth when connected
    setTimeout(() => {
      if (email === "oluwaseyi@afnanparfumes.com" && password === "APCB22385") {
        toast({
      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col justify-center px-12 text-white">
          ...
          <p className="text-lg opacity-75">
            Access your curated collection, affiliate commissions, and premium benefits
          </p>
        </div>
      </div>
        ...
        <Card className="w-full max-w-md shadow-luxury">
          <CardHeader className="space-y-4 text-center">
            <div className="flex items-center justify-center gap-2 lg:hidden">
              ...
              <h2 className="text-2xl font-bold">Prestige Circle</h2>
            </div>
          ...
          <CardContent>
            ...
            <div className="mt-6 text-center text-sm text-muted-foreground">
              <p>Demo Account: oluwaseyi@afnanparfumes.com</p>
              <p>Password: APCB22385</p>
            </div>
          </CardContent>
        </Card>
      </div>
